...
public class WekaAutomator {
	...
	public static void main(String[] args) throws Exception {
		...
		"/Users/roeeaharoni/research_data/icri-speech/ICSI-transcripts/arff/050915/Bed015_trans_010_011_vs_nbest_parse_t30_trans_010_011_arff");
		// get the arff files from the directory
		File[] arff_files = arffFolder.listFiles();

		// create the classifier instances
		Map<String, Classifier> classifiers = CreateClassifiers();
	...
	private static Map<String, Classifier> CreateClassifiers() {
